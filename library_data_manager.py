...
class LibraryDataManager:
    ...
    def mark_account(self, last: bool) -> None:
        self.write_user_json_file("last_account", {"last_account": last})
    ...
    def get_user_data(self) -> (dict[str, str] | None):
        ...
        try:
            ...
            if user_data is not None:
                self.change_api_keys(self.__steam_api._api_key, self.__steam_grid_api._api_key)
    ...
    def change_api_keys(self, steam_api_key: str, steam_grid_api_key: str) -> None:
        
        self.__steam_api._api_key = steam_api_key
        self.__steam_grid_api._api_key = steam_grid_api_key
        
        self.write_user_json_file("api_keys", {"steam_api_key": steam_api_key, "steam_grid_api_key": steam_grid_api_key})
